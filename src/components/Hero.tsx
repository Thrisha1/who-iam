    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="relative z-10 container px-6 text-center space-y-12">
        ...
        <div className="space-y-6">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent animate-gradient inline-block transform-gpu transition-transform duration-500 hover:scale-105">
              SOFTWARE ENGINEER
            </h1>
          </div>
