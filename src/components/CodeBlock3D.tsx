...
const codeLines = [
  ...
  '    "BTech CUSAT 2024"',
  "  ],",
  '  technologies: ["Elixir", "Node.js", "Remix", "React", "JavaScript", "SQL", "GraphQL"]',
  "};",
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 20px 60px rgba(0, 0, 0, 0.5), 0 0 40px rgba(14, 165, 233, 0.2)",
      }}
    >
      {/* Scanline effect */}
      <div
          ...
          >
            ...
            <span
              className={
                ...
                line.includes("role")
                  ? "text-accent"
                  : line.includes("Thrisha") ||
                      line.includes("Shopify") ||
                      line.includes("Engineer")
                    ? "text-primary"
                    : line.includes("50K+") || line.includes("CTO")
                      ? "text-destructive"
                      : "text-foreground"
              }
            >
